...
export default function AccountStatus() {
  ...
  useEffect(() => {
    ...
    // ✅ optional: keep it “real-time”
    const t = setInterval(fetchKycStatus, 15000); // every 15s
    return () => clearInterval(t);
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [token]);

  const kycUi = useMemo(() => {
    // default if api not loaded yet
  ...
  const showActionRequired =
    !kycStatus || (kycStatus !== "Approved" && kycStatus !== "InReview" && kycStatus !== "Submitted");
