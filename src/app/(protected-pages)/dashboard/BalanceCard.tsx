...
const BalanceCard = ({ cardData }: { cardData: CardData & { data: BalanceItem[] } }) => {
  const [activeBalanceTab, setActiveBalanceTab] = useState<'available' | 'locked'>('available');
        ...
        donut: {
          labels: {
            ...
            total: {
              ...
              fontSize: '14px',
              formatter: () => {
                const total = activeBalanceTab === 'available' 
        ...
        <div className="flex space-x-2">
          <button
            ...
            className={classNames(
              'text-xs font-medium px-2 rounded-md transition-colors',
              activeBalanceTab === 'available' 
