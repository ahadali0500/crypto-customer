...
const Page = () => {
    ...
    const getProcessedData = (tabKey: keyof PaginationState) => {
        ...
        // Sort data if needed
        const sortedData =
            sortBy && sortOrder ? sortData(rawData, sortBy, sortOrder) : rawData
                ...
                <div className="overflow-x-auto">
                    <DataTable
                        ...
                        onPaginationChange={(page) =>
                            handlePaginationChange('tickets', page)
                        }
                        onSelectChange={(pageSize) =>
                            handlePageSizeChange('tickets', pageSize)
                        }
                        onSort={(sortParams: OnSortParam) =>
                            handleSort('tickets', sortParams)
                        }
                    />
                </div>
            ),
            ...
            content: (
                <div className="overflow-x-auto">
                    <DataTable
                        ...
                        onPaginationChange={(page) =>
                            handlePaginationChange('deposits', page)
                        }
                        onSelectChange={(pageSize) =>
                            handlePageSizeChange('deposits', pageSize)
                        }
                        onSort={(sortParams: OnSortParam) =>
                            handleSort('deposits', sortParams)
                        }
                    />
                </div>
            ),
            ...
            content: (
                <div className="overflow-x-auto">
                    <DataTable
                        ...
                        onPaginationChange={(page) =>
                            handlePaginationChange('withdrawals', page)
                        }
                        onSelectChange={(pageSize) =>
                            handlePageSizeChange('withdrawals', pageSize)
                        }
                        onSort={(sortParams: OnSortParam) =>
                            handleSort('withdrawals', sortParams)
                        }
                    />
                </div>
            ),
