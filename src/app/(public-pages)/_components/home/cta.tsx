        ...
        <section className="bg-gradient-to-r from-blue-500 to-purple-600 py-20">
            <div className="max-w-7xl mx-auto px-4 text-center">
                ...
                <div className="flex justify-center flex-wrap gap-4">
                    {/* Primary Button */}
                    <button className="flex items-center justify-center bg-white text-blue-600 font-semibold py-3 px-8 rounded-md transition-all duration-300 hover:bg-gray-100 ">
                        Get Started Free
