...
const Input = (props: InputProps) => {
    ...
    const inputFocusClass = `focus:ring-slate-800  rounded-lg`
    ...
    const renderInput = (
        <Component
            style={{
                ...restStyle,
                ...(padding ? {} : affixGutterStyle()), // skip affix gutter if padding is already set
                ...(padding ? { padding } : {}),        // re-apply if needed
            }}
            {...inputProps}
        />
    )
